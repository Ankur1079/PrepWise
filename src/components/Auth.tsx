      ...
      <div className="absolute top-10 flex items-center gap-3">
        <div className="relative flex items-center justify-center shrink-0">
          <svg className="h-10 w-10" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="50" cy="50" r="38" stroke="url(#logoGradAuth)" strokeWidth="3" strokeDasharray="5 5" className="opacity-40 animate-[spin_40s_linear_infinite]" />
            <path d="M50 22 C34 22 26 32 26 48 C26 66 38 78 50 78 C62 78 74 66 74 48 C74 32 66 22 50 22 Z" stroke="url(#logoGradAuth)" strokeWidth="5" strokeLinecap="round" className="opacity-95" filter="url(#logoGlowAuth)" />
